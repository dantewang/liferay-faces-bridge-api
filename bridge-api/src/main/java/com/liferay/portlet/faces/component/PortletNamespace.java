 ...
 */
package com.liferay.portlet.faces.component;
...
public class PortletNamespace extends UIComponentBase {
	...
	// Public Constants
	public static final String COMPONENT_FAMILY = "com.liferay.portlet.faces.Namespace";
	public static final String COMPONENT_TYPE = "com.liferay.portlet.faces.Namespace";
	...
	public PortletNamespace() {
		super();
		setRendererType("com.liferay.portlet.faces.Namespace");
	}
