...
public class GenericFacesPortlet extends GenericPortlet {
	 ...
	 * implementation.
	 */
	public static final String BRIDGE_SERVICE_CLASSPATH = "META-INF/services/jakarta.portlet.faces.Bridge";
	 ...
	 * "META-INF/services/jakarta.portlet.faces.Bridge" using the current threads classloader and extracts the classname
