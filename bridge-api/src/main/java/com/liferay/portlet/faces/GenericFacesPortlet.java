 ...
 */
package com.liferay.portlet.faces;
 ...
 *
 * <ul>
 *   <li><code>com.liferay.portlet.faces.defaultViewId.[<i>mode</i>]</code>: specifies on a per mode basis the default viewId
 ...
 *   <li><code>com.liferay.portlet.faces.excludedRequestAttributes</code>: specifies on a per portlet basis the set of request
 ...
 *   <li><code>com.liferay.portlet.faces.preserveActionParams</code>: specifies on a per portlet basis whether the bridge
 ...
 *
 * <ul>
 *   <li><code>com.liferay.portlet.faces.BridgeImplClass</code>: specifies the <code>Bridge</code>implementation class used by
...
public class GenericFacesPortlet extends GenericPortlet {
	 ...
	 */
	public static final String BRIDGE_AUTO_DISPATCH_EVENTS = "com.liferay.portlet.faces.autoDispatchEvents";
	 ...
	 */
	public static final String BRIDGE_CLASS = "com.liferay.portlet.faces.BridgeClassName";
	...
	public static final String INITIALIZE_NAMESPACED_CONTEXT_ATTRIBUTES =
		"com.liferay.portlet.faces.initializeNamespacedContextAttributes";

	/**
	 * Location of the services descriptor file in a brige installation that defines the class name of the bridge
	 * implementation.
	 */
	public static final String BRIDGE_SERVICE_CLASSPATH = "META-INF/services/com.liferay.portlet.faces.Bridge";
	 ...
	 */
	@Deprecated
	public static final String DEFAULT_CONTENT_TYPE = "com.liferay.portlet.faces.defaultContentType";
	 ...
	 */
	@Deprecated
	public static final String DEFAULT_CHARACTERSET_ENCODING = "com.liferay.portlet.faces.defaultCharacterSetEncoding";
	 ...
	 */
	public static final String DEFAULT_VIEWID = "com.liferay.portlet.faces.defaultViewId";
	 ...
	 * com.liferay.portlet.faces.BridgeImplClass. If it doesn't exist then it looks for the resource file
	 * "META-INF/services/com.liferay.portlet.faces.Bridge" using the current threads classloader and extracts the classname
	 ...
	 *              "com.liferay.portlet.faces.defaultRenderKitId" instead.
	 *
	 ...
	 *              com.liferay.portlet.faces.defaultRenderKitId. If not present, <code>null</code> is returned.</p>
	 *
	 *              <p>Note that this method will only be called by {@link #init(PortletConfig)} if the {@link
	 *              #INITIALIZE_NAMESPACED_CONTEXT_ATTRIBUTES} init-param is <code>true</code> in
	 *              WEB-INF/portlet.xml.</p>
	 ...
	 *              "com.liferay.portlet.faces.defaultViewId.view", "com.liferay.portlet.faces.defaultViewId.edit", or
	 *              "com.liferay.portlet.faces.defaultViewId.help", etc.
	 *
	...
	/**
	 * @deprecated  Call {@link jakarta.faces.context.ExternalContext#getInitParameter(String)} with parameter
	 *              "com.liferay.portlet.faces.excludedRequestAttributes" instead.
	 *
	 ...
	 *              init-param com.liferay.portlet.faces.excludedRequestAttributes.</p>
	 *
	 *              <p>Note that this method will only be called by {@link #init(PortletConfig)} if the {@link
	 *              #INITIALIZE_NAMESPACED_CONTEXT_ATTRIBUTES} init-param is <code>true</code> in
	 *              WEB-INF/portlet.xml.</p>
	...
	public void init(PortletConfig portletConfig) throws PortletException {
		...
		if (bridge != null) {
			...
			// If the "com.liferay.portlet.faces.initializeNamespacedContextAttributes" init-param is specified in
			...
			if (initializeNamespacedContextAttributes) {
				...
				// attribute with name "com.liferay.portlet.faces.<portlet-name>.defaultViewIdMap"
				...
				// Save the "com.liferay.portlet.faces.excludedRequestAttributes" init-param value(s) as a portlet context
				// attribute with name "com.liferay.portlet.faces.<portlet-name>.excludedRequestAttributes"
				...
				// Save the "com.liferay.portlet.faces.preserveActionParams" init-param value as a portlet context attribute
				// with name "com.liferay.portlet.faces.<portlet-name>.preserveActionParams"
				...
				// If a com.liferay.portlet.faces.bridgeEventHandler is registered as an init-param in portlet.xml, then
				...
				if (bridgeEventHandlerInstance != null) {
					...
					// Attribute name format: com.liferay.portlet.faces.{portlet-name}.bridgeEventHandler
				...
				// If a com.liferay.portlet.faces.bridgePublicRenderParameterHandler is registered as an init-param in
				...
				if (bridgePublicRenderParameterHandlerInstance != null) {
					...
					// Attribute name format: com.liferay.portlet.faces.{portlet-name}.bridgePublicRenderParameterHandler
				...
				// If a com.liferay.portlet.faces.defaultRenderKitId is specified as an init-param in WEB-INF/portlet.xml then
	...
	/**
	 * Returns the value of the portlet initialization parameter <code>com.liferay.portlet.faces.autoDispatchEvents</code> if
	...
	/**
	 * @deprecated  Call {@link jakarta.faces.context.ExternalContext#getInitParameter(String)} with parameter
	 *              "com.liferay.portlet.faces.preserveActionParams" instead.
	 *
	 ...
	 *              from the portlet init-param com.liferay.portlet.faces.preserveActionParams. If not present, false is
	 *              returned.</p>
	 *
	 *              <p>Note that this method will only be called by {@link #init(PortletConfig)} if the {@link
	 *              #INITIALIZE_NAMESPACED_CONTEXT_ATTRIBUTES} init-param is <code>true</code> in
	 ...
	 * for the current view according to its associated {@link jakarta.portlet.PortletMode} and {@link
	 * jakarta.portlet.WindowState}. The markup is captured during the {@link PortletRequest#HEADER_PHASE} so that it can
	...
	/**
	 * If the <code>com.liferay.portlet.faces.automaticNonFacesViewDispatching</code> init-param is <code>true</code> and the
	...
	protected void doDispatch(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException,
		...
		String autoNonFacesViewDispatch = getInitParameter("com.liferay.portlet.faces.automaticNonFacesViewDispatching");
